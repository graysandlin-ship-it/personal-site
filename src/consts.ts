...
export const SITE_TAGLINE =
	'Technology, execution, athlete mentality, and a long-term interest in building useful things for the real world.';
...
export const SOCIAL_LINKS = [
	{
		label: 'LinkedIn',
		href: 'https://www.linkedin.com/in/grayson-sandlin',
	},
	{
		label: 'Email',
